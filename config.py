...
class Var:
    ...
    ALIVE_PIC = getenv("ALIVE_PIC", "https://telegra.ph/file/25191c0ea675c9b171882.jpg")
    ALIVE_TEXT = getenv("ALIVE_TEXT", "Hey, Saya AmwangPyrobot Dibuat dengan basis pyrogram versi terbaru")
